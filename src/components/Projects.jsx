...
const Projects = () => {
  ...
  return (
    <section className="projects" ref={scrollTab}>
      <div className="title text-5xl font-bold mb-8 flex justify-center gap-3" ref={(el) => el && divs.current.push(el)} >
        My<span className="text-orange-500">Projects</span> 
      </div>
      <div className="des " ref={(el) => el && divs.current.push(el)} >
        {/* 20 */}
        These are some of my unique projects, creating
          responsive user interfaces and efficient back-end systems. My
          expertise ensures seamless, scalable web applications from front to
          back.
      </div>
      <div className="list">
        {listProjects.map((value, key) => (
          <div
            className="item scroll-up"
            key={key}
            
          >
            <a href={value.link}><div className="images">
              <img src={value.images} alt="" />
            </div></a>
            <div className="content">
              <h3 className="font-bold ">{value.name}</h3>
              <div className="ml-3 my-5 text-gray-800 font-medium ">{value.des}</div>
              <div className="mission">
                ...
                <div>
                  <h4>Mission</h4>
                  <div className="  text-gray-500 font-semibold text-sm">{value.mission}</div>
                </div>
              </div>
              <div className="mission">
                <div>
                ...
                <div>
                  <h4>Languages</h4>
                  <div className="text-gray-500 font-semibold text-sm">{value.language} <a href={value.link}><button  className= " ml-32 bg-gray-200 hover:bg-orange-500 text-white rounded-xl px-5 py-3 text-base ">
